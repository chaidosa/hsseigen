...
double* trifmm1d_local_shift_2(int r, double *x, double *y, double * q, const double *gap, const int* org, const int fun, const int numXElems, int numYElems, const int scaling=1);
